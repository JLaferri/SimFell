...
public class RPPM
{
    ...
    {
        double currentTime = (unit.Simulator.Now - unit.Simulator.Env.StartDate).TotalSeconds;
    ...
    {
        _lastProcAttemptTime = resetBasedOnElapsedTime
            ? (unit.Simulator.Now - unit.Simulator.Env.StartDate).TotalSeconds
            : 0;
    }
}